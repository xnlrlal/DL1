'''
    1. Intelligence(지능)
        ...
        4) 컴퓨터가 스스로 방법을 찾아냄 : 데아터를 기반으로 스스로 학습할 수 있음
    ...
    3. 머신러닝 종류
        1) 지도 학습 (supervised learning)
            ...
            - 예) 고양이, 개를 구분할 때 고양이인지 개인지 레이블링된 데이터를 충분히 제공한 뒤에
                  학습을 하도록 하는 과정이 필요.
                - 학습 단계 => 예측 모델 => 테스트 단계
        2) 비지도 학습 (unsupervised learning)
            - 정답(레이블)을 주지 않고 학습 알고리즘이 스스로 어떤 구조를 발견하는 학습
            - 군집합(clustering) : 주어진 데이터를 특성에 따라 둘 이상 그룹으로 나누는 것
            ...
            - 주택의 면적이 큰 경우 판매 가격도 높은 경우가 많음.
                ...
                - 관측된 데이터를 바탕으로 다차원 공간에 존재하는 데이터들을 가장 잘 설명하는 수학 함수를 찾는 것
                    ...
                    - 이 둘 사이 상관관계가 1차 방정식으로 표현될 수 있는 선형관계라고 함
                        - 주택면적 x와 거래가격 y의 관계는 y= wx + b 로 표현됨
                        - 기울기 w와 절편 b를 어떻게 정의하는 가에 따라 표현 할 수 있음.
